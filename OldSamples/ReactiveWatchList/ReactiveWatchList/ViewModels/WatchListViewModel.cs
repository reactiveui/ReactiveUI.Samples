...
namespace ReactiveWatchList.ViewModels
{
    ...
    public class WatchListViewModel : ReactiveObject
    {
        ...
        private void LoadDefaultStocks()
        {
            ...
            {
                stocks.Clear();
                stocks.Add(new WatchListItemViewModel("MSFT") {Price = 45.91m});
                stocks.Add(new WatchListItemViewModel("AAPL") {Price = 100.1m});
                stocks.Add(new WatchListItemViewModel("GOOG") {Price = 117.32m});
